#!/usr/bin/env bash
# ==============================================================================
# Lumina Edge :: Core Controller (NVIDIA CUDA) — Linux
...
if ! nvidia-smi &>/dev/null; then
    ...
    echo "Please ensure you have:"
    echo "  - NVIDIA GPU physically installed"
    echo "  - Correct NVIDIA drivers loaded"
    echo ""
...
if [[ ! -d "$BIN" ]]; then
    ...
    echo ""
    echo "Look for: llama-bXXX-bin-ubuntu-x64-cuda.zip"
    echo ""
    pause
    exit 1
fi
